...
\begin{center}
    {\captionfontsize \textsf{\textbf{SIX}}}\end{center}
        {\textfontsize \small Someone new arrives. Who? Why have they come? Are they in distress? OR Someone who leaves the community? Who? What are they looking for?}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \All}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{FRANKLY MY DEAR I DON'T GIVE A DAMN}}}\end{center}
        {\textfontsize You may sacrifice a \NoPawn\ to move another piece in it's normal chess manner.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Tomorrow, I'll think of some way to get him back. ---Scarlett O'Hara}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){T};
    \end{tikzpicture}%
...
\begin{center}
    {\captionfontsize \textsf{\textbf{DROP BEAR}}}\end{center}
        {\textfontsize You must drop if legal. You can't check when you may drop.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{tikzpicture}
    ...
    \node[text width=(\cardwidth-\strippadding-2*\textpadding)*1cm,below right,inner sep=0] at (\strippadding+\textpadding,\cardheight-\textpadding) 
    { 
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \inlinegraphics{bullrush}}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{BULL RUSH}}}\end{center}
        {\textfontsize \King\ may move forward any number of squares and wins if he reaches the last rank.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{Don't take the bull by the horns, take him by the tail; then you can let go when you want to. ---Josh Billings}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){+};
    \end{tikzpicture}%
...
\begin{center}
    {\captionfontsize \textsf{\textbf{MAXIMUM EFFORT}}}\end{center}
        {\textfontsize Choose to move or take. Pieces must then act as far as legally possible.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
...
\begin{tikzpicture}
    ...
    \node[text width=(\cardwidth-\strippadding-2*\textpadding)*1cm,below right,inner sep=0] at (\strippadding+\textpadding,\cardheight-\textpadding) 
    { 
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \fontsize{60pt}{40pt}\selectfont \Bishop\Knight\Rook}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{ROCK, PAPER, SCISSORS}}}\end{center}
        {\textfontsize Bishops can't take Knights which can't take Rooks which can't take Bishops.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{\small Lisa: Poor predictable Bart. Always takes 'rock'. \\Bart: Good ol' rock. Nuthin' beats that! --The Simpsons}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){-};
    \end{tikzpicture}%
...
\begin{center}
    {\captionfontsize \textsf{\textbf{SUMO PAWNS}}}\end{center}
        {\textfontsize \Pawn\Move: A \Pawn\ may push any number of \NoPawn\ pieces while moving.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{The world is moved along, not only by the mighty shoves of its heroes, but also by the aggregate of the tiny pushes of each honest worker. --Helen Keller}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){+};
    \end{tikzpicture}%
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \KI}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{BERSERKER}}}\end{center}
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \Drop}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{FAMINE}}}\end{center}
        {\textfontsize You may only drop a piece if you have another in supply.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{\tiny Near the gates and within two cities there will be scourges the like of which was never seen: famine within plague, people put out by steel, crying to the great immortal God for relief. ---Nostradamus}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){C};
    \node[circle,draw,text=black](c) at (\cardwidth-.5,\cardheight-.5){-};
    \end{tikzpicture}%
...
\begin{center}
    {\captionfontsize \textsf{\textbf{NOBLESSE OBLIGE}}}\end{center}
        {\textfontsize {\KI} cannot be attacked by pawns, but also may not attack the king.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
